...
<body class="hold-transition sidebar-mini">
    ...
    <script src="<?php echo public_url();  ?>plugins/inputmask/min/jquery.inputmask.bundle.min.js"></script>
    <!-- date-range-picker -->
    ...
    <!-- AdminLTE -->
    <script src="<?php echo public_url();  ?>js/adminlte.js"></script>
