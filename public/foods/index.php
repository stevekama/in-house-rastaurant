...
$food_type = htmlentities($_GET['type']);

$current_food_type = $type->find_by_type($food_type);
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">
                        <?php echo htmlentities($current_food_type['type']); ?>
                    </li>
                </ol>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        const type = '<?php echo htmlentities($current_food_type['type']); ?>';
